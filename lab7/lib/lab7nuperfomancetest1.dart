...
class lab7perfomancetest1 extends StatelessWidget{
  @override
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child:Row(
              children: [
                getCustomExpandedWidget(tital: 'brown',color: Colors.brown,flex: 2),
                Expanded(
                  child:Column(
                    children: [
          ...
          Expanded(
            child: Row(
              children: [
                ...
                getCustomExpandedWidget(tital: 'blue',color: Colors.blue,fontsize: 50.0,fontwight: FontWeight.w900),
              ],
            ),
          ),
